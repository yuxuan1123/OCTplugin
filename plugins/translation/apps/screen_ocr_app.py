"""
translation/apps/screen_ocr_app.py
─────────────────────────────────
最终应用 · 屏幕OCR应用 = 屏幕OCR + 悬浮显示框（1:1 复刻 OCTools）。
按钮：[retry, copy, pin, close]，SHOW_ORIG=False，REQUIRES_REGION=True，
USE_TRANSLATE=False（仅识别）。
"""
